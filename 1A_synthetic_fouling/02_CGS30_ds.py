...
def make_dataset_timelines(root_dir, partition, num_days, num_scenarios):
	...
	for scenario_num in tqdm(range(1, num_scenarios + 1), desc='Generating timelines for scenarios'):
		max_daily_growth = 10.0
		min_daily_growth = 0.0
...
if __name__ == '__main__':
	max_vignette_strength = 25.0
	min_vignette_strength = 19.0
	...
	data_dir = '/Users/nick_1/Bell_5G_Data/CGS30_ds'
	sm_data_dir = '/Users/nick_1/Bell_5G_Data/sm_CGS30_ds'
